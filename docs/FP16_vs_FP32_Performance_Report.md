...
|------|-------------------|-------------------|-----------------|----------------------|
| **单次迭代时间** | 561.73s | 46.03s | 27.0s | **0.59x (4090 快 1.7x)** |
| **Action 生成** | - | ~23s | 13.0s | 0.57x |
| **World Model 交互** | - | ~23s | 13.4s | 0.58x |
| **FP32→FP16 加速比** | - | **12.2x** | N/A | - |

> **注**: RTX 4090 数据使用精简打桩 (仅 4 个计时点)，开销约 5.5%。无打桩实测 25.56s/iter。
